    ...
    embeds: [
      {
       ...
       :eyes: peep **[vibes.live](http://www.vibes.live/ledger/${ledger_id}/discord_member-${receiving_member.member_id})** to see what @${receiving_member.username} received
...
//   url: `${process.env.VIBES_LIVE_BASE_URL}/ledger/${ledger_id}`,
//   description: `:eyes: peep **[vibes.live](http://www.vibes.live/ledger/${ledger_id}/profile/discord_member-${targetedUser.member_id})** to see your profile
//   :clipboard: Full Tx log – **[vibescan.io](${process.env.VIBESCAN_BASE_URL}/ledger/${ledger_id}/entries)**`,
